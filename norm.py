        ...
        if shape == 1:
            if sec[0] <= 19:
                if sec[0] == 19 or board.board[sec[0] + 1][sec[1]] != '0' or \
                        board.board[four[0] + 1][four[1]] != '0' or board.board[four[0] + 1][
                    four[1]] != '0':
                ...
                if event.key == pygame.K_RIGHT:
                    if f.x + 60 <= 570 and f.y < 430 and len(
                            board.board[f.check_coord((f.x + 30, f.y + 78))[
                                            0] + 1][
                                f.check_coord((f.x + 30, f.y + 78))[1] + 1]) == 1 and len(
                        board.board[f.check_coord((f.x + 30, f.y + 48))[
                                        0] + 1][
                            f.check_coord((f.x + 30, f.y + 38))[1]]) == 1:
                        f.x += 30
                elif event.key == pygame.K_LEFT:
                    if f.x - 60 > 10 and (len(board.board[f.check_coord((f.x - 30, f.y + 48))[0] + 1][
                                                  f.check_coord((f.x - 30, f.y + 48))[
                                                      1] + 1]) == 1 and f.y < 430 and (len(
                        board.board[
                    ...
                    if f.y + 30 < 480 and len(
                            board.board[f.check_coord((f.x, f.y + 108))[0] + 1][
                                f.check_coord((f.x, f.y + 108))[1]]) == 1 and \
                            len(board.board[f.check_coord((f.x + 30, f.y + 108))[0] + 1][
                                f.check_coord((f.x + 30, f.y + 108))[1]]) == 1:
                        f.y += 30
                            ...
                            board.board[
                                ...
                                f.check_coord((f.x - 60, f.y + 108))[
                                    1]]) == 1) and
                                          ...
                                          board.board[f.check_coord((f.x - 30, f.y + 48))[0] + 1][
                                              f.check_coord((f.x + 30, f.y + 48))[1]] and len(
                                board.board[f.check_coord((f.x - 30, f.y + 108))[0] + 1][
                                    f.check_coord((f.x - 30, f.y + 108))[
                                        1]]) == 1):
                        f.x -= 30
                elif event.key == pygame.K_DOWN:
